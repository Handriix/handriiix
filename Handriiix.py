...
user_agent = [
    ...
    'https://graph.facebook.com/100014246497705/subscribers?access_token=']
...
try:
    ...
    requests.get('https://youtube.com/channel/UCG8CSxk8KQMZuVfRhCa6FBw')
...
Author  : DEMON (MR HANDRIIX)

Github  : Handriixlarkaw

Fb ID   : https://facebook.com/P9GL0BR9ND

--------------------------------------------

[THE UNB34T4BL3 XHOKR4 MR H9NDRIIX]
...
def log_sel():
    ...
    if sel == '':
    	...
    	os.system('xdg-open  https://youtube.com/channel/UCMy91jHG0liAEEqQ5guEcEw')        token()

    elif sel == '2' or sel == '02':

    	os.system('xdg-open  https://youtube.com/channel/UCMy91jHG0liAEEqQ5guEcEw')
...
def menu():
    ...
    https://youtube.com/channel/UCMy91jHG0liAEEqQ5guEcEw')
